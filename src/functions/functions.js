...
// // import jwtEncrypt from "jwt-decode";
...
//     // const jwt = jwt.encrypt(str);
//     const ciphertext = CryptoJS.encrypt(JSON.stringify(str), 'secret key 123').toString();
...
//     const jwt = jwt.encrypt(str);
//     // const simpleCrypto = new SimpleCrypto(str);
//     return jwt.decrypt(token, mode === "obj" ? true : false);
//   } catch (err) {
//     return undefined;
//   }
// };
